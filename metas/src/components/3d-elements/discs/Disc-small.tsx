    ...
    return (
        <group {...props} dispose={null}>
            ...
            <mesh
                castShadow
                receiveShadow
                geometry={nodes.ImperfectRock002.geometry}
                material={materials["Material.001"]}
                position={[0.24, 0.22, -0.07]}
            ...
            <mesh
                ...
                position={[-0.16, 0.07, 0.09]}
                rotation={[1.48, 0.07, -2.29]}
                scale={0.33}
            />
            <mesh
                castShadow
