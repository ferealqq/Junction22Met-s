  ...
  return (
    <group {...props} dispose={null} ref={mesh}>
      <mesh
        ...
        position={[-0.08, -0.05, 1.67]}
        scale={[1.67, 0.57, 1.67]}
      />
      <group position={[0.13, -0.04, 1.18]} scale={0.44}>
        <mesh
      ...
      <mesh
        ...
        position={[0.22, -0.04, 1.66]}
        rotation={[0, -0.63, 0]}
        scale={0.37}
      />
      <group
        position={[0.38, -0.04, 1.85]}
        rotation={[0, -0.84, 0]}
        scale={0.44}
      >
        <mesh
      ...
      <mesh
        ...
        position={[-0.51, 0.08, 1.96]}
        rotation={[Math.PI / 2, 0, -0.6]}
        scale={0.45}
      />
      <group position={[-0.17, -0.05, 1.56]} scale={[0.39, 0.29, 0.39]}>
